...
@Client.on_message(filters.private & filters.command('set_join'))
...
@Client.on_message(filters.private & filters.command('del_join'))
...
@Client.on_message(filters.private & filters.command(['view_join', 'see_join']))
...
@Client.on_message(filters.private & filters.command(['view_type', 'see_type']))
...
@Client.on_message(filters.private & filters.command('del_type'))
